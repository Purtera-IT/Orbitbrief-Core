...
Full field catalog with concrete example values lives in the sibling
[parser-os](https://github.com/Purtera-IT/parser-os) repo at
`OUTPUTS_FOR_UI.md`.
...
local Ollama (or remote vLLM) for the LLM tier. The Azure deployment
plan lives in the sibling [parser-os](https://github.com/Purtera-IT/parser-os)
repo at `INTEGRATION_GUIDE.md`. It covers:
...
| Deploy to Azure | `parser-os/INTEGRATION_GUIDE.md` (sibling repo) |
| See every PM_HANDOFF field | `parser-os/OUTPUTS_FOR_UI.md` (sibling repo) |
