...
class StaffAugmentationBrain(BriefingBrain):
    """Thin :class:`BriefingBrain` subclass for the staff_augmentation pack."""
...
StaffAugmentationScopeState = BriefingState
