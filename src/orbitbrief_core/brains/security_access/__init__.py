...
DOMAIN_ID = "security_access"


class SecurityAccessBrain(BriefingBrain):
    """Thin :class:`BriefingBrain` subclass for the security_access pack."""
...
SecurityAccessScopeState = BriefingState
