"""CameraVmsOperations brain (PR 19).
...
DOMAIN_ID = "camera_vms_operations"


class CameraVmsOperationsBrain(BriefingBrain):
    """Thin :class:`BriefingBrain` subclass for the camera_vms_operations pack."""
...
CameraVmsOperationsScopeState = BriefingState
...
__all__ = [
    ...
    "CANONICAL_SECTIONS",
    "DOMAIN_ID",
    "CameraVmsOperationsBrain",
    "CameraVmsOperationsScopeState",
    "BriefingBrainResult",
]
