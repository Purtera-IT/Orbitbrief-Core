...
DOMAIN_ID = "paging_mass_notification"


class PagingMassNotificationBrain(BriefingBrain):
    """Thin :class:`BriefingBrain` subclass for the paging_mass_notification pack."""
...
PagingMassNotificationScopeState = BriefingState
...
__all__ = [
    ...
    "DOMAIN_ID",
    "PagingMassNotificationBrain",
    "PagingMassNotificationScopeState",
    "BriefingBrainResult",
]
