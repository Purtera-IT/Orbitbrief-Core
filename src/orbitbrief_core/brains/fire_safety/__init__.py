...
DOMAIN_ID = "fire_safety"


class FireSafetyBrain(BriefingBrain):
    """Thin :class:`BriefingBrain` subclass for the fire_safety pack."""
...
FireSafetyScopeState = BriefingState
