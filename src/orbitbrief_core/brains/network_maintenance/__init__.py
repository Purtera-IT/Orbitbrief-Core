"""NetworkMaintenance brain (PR 19).
...
class NetworkMaintenanceBrain(BriefingBrain):
    """Thin :class:`BriefingBrain` subclass for the network_maintenance pack."""
...
NetworkMaintenanceScopeState = BriefingState
...
__all__ = [
    ...
    "CANONICAL_SECTIONS",
    "DOMAIN_ID",
    "NetworkMaintenanceBrain",
    "NetworkMaintenanceScopeState",
    "BriefingBrainResult",
]
