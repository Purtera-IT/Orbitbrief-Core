...
class AudioVisualBrain(BriefingBrain):
    """Thin :class:`BriefingBrain` subclass for the audio_visual pack."""
...
AudioVisualScopeState = BriefingState
