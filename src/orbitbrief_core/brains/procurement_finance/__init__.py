"""ProcurementFinance brain (PR 19).
...
DOMAIN_ID = "procurement_finance"


class ProcurementFinanceBrain(BriefingBrain):
    """Thin :class:`BriefingBrain` subclass for the procurement_finance pack."""
...
ProcurementFinanceScopeState = BriefingState
...
__all__ = [
    ...
    "CANONICAL_SECTIONS",
    "DOMAIN_ID",
    "ProcurementFinanceBrain",
    "ProcurementFinanceScopeState",
    "BriefingBrainResult",
]
