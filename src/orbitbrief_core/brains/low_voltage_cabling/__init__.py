"""Low Voltage Cabling brain (Phase 7.5).

Briefing-shaped output (canonical 9 sections) with prompt sourced from
the OrbitBrief intake workbook (D05_low_voltage_cabling). The workbook's per-field
...
class LowVoltageCablingBrain(BriefingBrain):
    """Low Voltage Cabling OrbitBrief brain. Thin :class:`BriefingBrain` subclass."""
...
LowVoltageCablingScopeState = BriefingState
...
__all__ = [
    ...
    "CANONICAL_SECTIONS",
    "DOMAIN_ID",
    "LowVoltageCablingBrain",
    "LowVoltageCablingScopeState",
    "BriefingBrainResult",
]
