...
def extract_floorplan_sheet(
    *,
    page_index: int,
    text: str,
    sheet_type: str = "floorplan_overall",
    sheet_title: str = "",
    ...
    if sheet_type == "floorplan_detail":
    ...
    base_regions = regions if regions is not None else build_page_regions(page_index=page_index, text=text, sheet_type=sheet_type, sheet_title=sheet_title)
