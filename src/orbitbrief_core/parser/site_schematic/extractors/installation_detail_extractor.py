...
def extract_installation_detail_sheet(
    *,
    page_index: int,
    text: str,
    sheet_title: str = "",
    ...
    base_regions = regions if regions is not None else build_page_regions(page_index=page_index, text=text, sheet_type="installation_detail", sheet_title=sheet_title)
