...
def test_grounding_state_policy():
...
def test_legend_text_association():
...
def test_packet_hardpage_summary():
    rows = [
    ...
    s = build_packet_hardpage_summary("packet", rows)
    assert s.rate == 1.0
